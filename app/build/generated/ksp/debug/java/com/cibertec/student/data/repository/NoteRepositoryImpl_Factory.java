...
public final class NoteRepositoryImpl_Factory implements Factory<NoteRepositoryImpl> {
  ...
  public static NoteRepositoryImpl_Factory create(javax.inject.Provider<NoteDao> noteDaoProvider) {
    return new NoteRepositoryImpl_Factory(Providers.asDaggerProvider(noteDaoProvider));
  }

...
public abstract class Hilt_NotesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotesFragment_GeneratedInjector) this.generatedComponent()).injectNotesFragment(UnsafeCasts.<NotesFragment>unsafeCast(this));
    }
  }

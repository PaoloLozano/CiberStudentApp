...
public abstract class Hilt_AttendanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AttendanceFragment() {
    super();
  }

  Hilt_AttendanceFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AttendanceFragment_GeneratedInjector) this.generatedComponent()).injectAttendanceFragment(UnsafeCasts.<AttendanceFragment>unsafeCast(this));
    }
  }

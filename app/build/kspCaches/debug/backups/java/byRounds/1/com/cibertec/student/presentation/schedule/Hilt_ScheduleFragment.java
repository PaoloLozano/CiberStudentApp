...
public abstract class Hilt_ScheduleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScheduleFragment() {
    super();
  }

  Hilt_ScheduleFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScheduleFragment_GeneratedInjector) this.generatedComponent()).injectScheduleFragment(UnsafeCasts.<ScheduleFragment>unsafeCast(this));
    }
  }

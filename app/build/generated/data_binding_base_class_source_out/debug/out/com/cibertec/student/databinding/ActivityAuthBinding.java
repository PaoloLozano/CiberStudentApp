...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView navHostAuth;

  private ActivityAuthBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView navHostAuth) {
    this.rootView = rootView;
    this.navHostAuth = navHostAuth;
  }
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.nav_host_auth;
      FragmentContainerView navHostAuth = ViewBindings.findChildViewById(rootView, id);
      if (navHostAuth == null) {
        break missingId;
      }

      return new ActivityAuthBinding((ConstraintLayout) rootView, navHostAuth);
    }

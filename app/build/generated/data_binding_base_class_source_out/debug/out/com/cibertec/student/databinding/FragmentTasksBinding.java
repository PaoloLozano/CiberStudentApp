...
public final class FragmentTasksBinding implements ViewBinding {
  ...
  private FragmentTasksBinding(@NonNull CoordinatorLayout rootView, @NonNull Chip chipAll,
      @NonNull Chip chipDone, @NonNull ChipGroup chipGroupFilter, @NonNull Chip chipInProgress,
      @NonNull Chip chipPending, @NonNull LinearLayout emptyState,
      @NonNull ExtendedFloatingActionButton fabAddTask, @NonNull RecyclerView rvTasks,
  ...
  public static FragmentTasksBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTasksBinding((CoordinatorLayout) rootView, chipAll, chipDone,
          chipGroupFilter, chipInProgress, chipPending, emptyState, fabAddTask, rvTasks, toolbar);
    }
